...
5. Submit before your state snapshot becomes stale.
...
- submit after reading finalized state

## Continue reading

- Product integration guide:
  [Build resilient flows with forced transactions](../../network/build/forced-transactions.mdx)
